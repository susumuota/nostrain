...
import { parseReferences } from '../dist/nostrain';
...
test('parse mentions', () => {
  const evt = {
    ...
    content:
      'hello #[0], have you seen #[2]? it was made by nostr:nprofile1qqsvc6ulagpn7kwrcwdqgp797xl7usumqa6s3kgcelwq6m75x8fe8yc5usxdg on nostr:nevent1qqsvc6ulagpn7kwrcwdqgp797xl7usumqa6s3kgcelwq6m75x8fe8ychxp5v4! broken #[3]',  // cspell:disable-line
  };
  ...
  expect(parseReferences(evt)).toEqual([
    ...
    {
      text: 'nostr:nprofile1qqsvc6ulagpn7kwrcwdqgp797xl7usumqa6s3kgcelwq6m75x8fe8yc5usxdg', // cspell:disable-line
      profile: {
        pubkey:
